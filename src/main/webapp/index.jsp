        ...
        <div class="row">
            ...
            <div class="col-sm-8 col-md-8">
                ...
                <%--<div class="title-modelbox-widget wow bounce" data-wow-duration="1s" data-wow-delay="0s"
                     data-wow-iteration="1" style="box-shadow:0px 0px 5px 5px #6A5353">--%>
                <div class="title-modelbox-widget wow" data-wow-duration="1s" data-wow-delay="0s"
                         data-wow-iteration="1" style="box-shadow:0px 0px 5px 5px #6A5353">
            ...
            <div class="col-sm-4 col-md-4">
                ...
                <div class="title-modelbox-widget wow" data-wow-duration="1s" data-wow-delay="0s"
                     data-wow-iteration="1" style="box-shadow:0px 0px 5px 5px #564343">
    ...
    <div class="container"><!-- 使用bootstrap css框架，container定宽，并剧中 https://v3.bootcss.com/css/#overview-container -->
        ...
        <div class="row">
            ...
            <div class="col-sm-12 col-md-12">
                ...
                <div class="title-modelbox-widget wow" data-wow-duration="1s" data-wow-delay="0s"
                     data-wow-iteration="1" style="box-shadow:0px 0px 5px 5px #624545">
