            ...
            <div class="col-sm-12 col-md-12">
                ...
                <div class="title-modelbox-widget">
                    ...
                    <h3 class="section-title">
                        <div class="more">
                            <%--需要向pinglun_add.jsp传递以下两个参数：
                                biao：该参数内容是写死的为caipinxinxi
                                id：这个页面的菜品id--%>
<%--
                            <a href="pinglun_add.jsp">
--%>
                            <a href="pinglun_add.jsp?id=${map.id}&biao=caipinxinxi&caipinmingcheng=${map.caipinmingcheng}&caipinbianhao=${map.caipinbianhao}">
                                评论</a>
                        </div>
                        菜品详情 </h3>
